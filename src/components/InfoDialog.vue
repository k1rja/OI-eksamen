<script setup>
  ...
  const props = defineProps({
    ...
    showBookButton: { type: Boolean, default: false },
  })
  ...
  function onOpen () {
    if (!hasAnyExtraInfo.value && !props.showBookButton) return
    open.value = true
  }
...
<template>
  <button
    type="button"
    class="infoBtn"
    :disabled="!hasAnyExtraInfo && !showBookButton"
    @click="onOpen"
  >
    {{ buttonLabel }}
  </button>
    ...
    >
      <div class="infoModal__dialog">
        ...
        <div class="infoModal__body">
          ...
          <!-- OM ... kun hvis der ER en rigtig beskrivelse/lead -->
          <section v-if="primaryText" class="infoSection">
        ...
        <footer class="infoModal__footer">
          <button
            type="button"
            class="infoBtn infoBtn--secondary"
            @click="onClose"
          >
            Luk
          </button>
